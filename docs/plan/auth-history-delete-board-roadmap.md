---
title: Auth, history, deletion, board roadmap
summary: Final Wave 1-4 implementation plan for Firebase Auth, owner-scoped conversion history, deletion, Cloud Tasks conversion, member board, deployment, smoke, and verification.
date: 2026-06-23
tags: [roadmap, auth, history, deletion, board, cloud-tasks, deployment]
---
...
- [ ] F4. Scope fidelity and docs review
